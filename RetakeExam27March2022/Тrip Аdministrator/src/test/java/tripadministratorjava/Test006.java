...
public class Test006 {
    ...
    public void TestAddTripForCompanyWithTheSameIdNumber() {
        this.tripAdministrations.addCompany(c2);
        this.tripAdministrations.addTrip(c2, t1);
        this.tripAdministrations.addTrip(c2, t1);
        //new Trip("test", 1, Transportation.NONE, 1)
    }
    @Test(expected = IllegalArgumentException.class)
    public void TestAddTripForCompanyWithNoTripCapacity() {
        this.tripAdministrations.addCompany(c2);
        this.tripAdministrations.addTrip(c2, t1);
        this.tripAdministrations.addTrip(c2, new Trip("test", 1, Transportation.NONE, 1));
    }
}